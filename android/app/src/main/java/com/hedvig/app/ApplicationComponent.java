...
@Singleton
@Component(modules = { AndroidSupportInjectionModule.class, ApplicationModule.class, OwldroidModule.class, ViewModelModule.class, FragmentContributorModule.class})
