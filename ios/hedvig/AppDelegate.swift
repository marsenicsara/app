...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(
        ...
        let segmentKey = ReactNativeConfig.env(for: "SEGMENT_IOS_WRITE_KEY")
        
        RNASegmentIO.setup(withKey: segmentKey, options: [:])
        RNBranch.setRequestMetadataKey("$segment_anonymous_id", value: SEGAnalytics.shared().getAnonymousId() as NSObject)
